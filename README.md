...
**Course:** MIS — AI for Social Good | SJSU Spring 2025  
...
**What the AI does:** Gemini 2.0 Flash receives that input through a system prompt that instructs it to act as an SJSU Dining Services assistant. It generates a 3–4 sentence pickup alert written in a warm, welcoming tone — not clinical or bureaucratic — suitable for posting directly to students.
...
**The real-world consequence:** Maria walks across campus at 6:30 PM based on the alert, finds nothing, and loses trust in the system. Worse, if food that had been sitting out too long was redirected to the Spartan Food Pantry without a staff safety check, a student could consume food that causes illness.
